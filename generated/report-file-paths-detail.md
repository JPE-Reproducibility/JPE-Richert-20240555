...
**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/estimation/npestimator.m**

- Line 17, unix : %construct X(NOI,yI) with a row for each unique bidder/auction pair

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/computation/pairwise_jointd_estimator_imm.m**
...
**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/computation/evalkspdf_num.m**

- Line 23, windows : fprintf('Kernel choice not defined or spelt wrong\n')

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/estimation/complex_bootstrap.m**
...
- Line 18, windows : fprintf('--- verify_env ---\n');
- Line 20, windows : try, fprintf('  BLAS %s\n', version('-blas')); catch, end
- Line 21, windows : fprintf('  CPU %s\n', strtrim(cpu));
- Line 23, windows : fprintf('  fingerprint %s\n', fp_str);
- Line 30, unix : '(Windows: setx MKL_CBWR AVX512, new terminal/restart; Linux: export MKL_CBWR=AVX512), ' ...
- Line 38, unix : [~, f] = system('grep -m1 -o avx512f /proc/cpuinfo');
- Line 50, windows : fprintf('  OK\n');
...
**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/computation/cdf_estimator_imm.m**

- Line 54, unix : % 1. probability of a yd that is negative/positive

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/computation/evalkspdf.m**
...
**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/cfs/doubleauctionOuter_1stepspecial_yin.m**

- Line 24, unix : %26-28 yin construction from linear projection of p/qs

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/postestimation/robustnesschecks.m**
...
**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/computation/permn.m**

- Line 72, unix : %   erroneous values. His excellent solution was to add (1/2) to the values

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/computation/BsplineEval3.m**

- Line 13, unix : %contain the first, second, and/or third derivatives of f at the points in

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/datacleaning/bondprices.m**
...
- Line 64, unix : % Release date: 3/6/2007
- Line 167, unix : srinv = 1/StepRatio;
- Line 192, windows : rinv = rromb\eye(nexpon+1);

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/cfs/weightsolnpricespartialgridINTs1_yin.m**

- Line 106, unix : %Grid/extrap

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/main_cds.m**

- Line 147, windows : fprintf('%-25s %16s %16s %16s\n', '', 'Mean Price', 'SD Price', 'Surplus ($M)')
- Line 153, windows : fprintf(fid, ' & Mean Price & SD Price & Surplus (\\$M) \\\\\n\\hline\n');
- Line 158, unix : disp('Table OS.6 saved to output/tables/tableOS6.tex')
...
**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/estimation/v_correction.m**
...
**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/datacleaning/cleanbondprice.m**
...
**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/cfs/smc_cfs_yin.m**

- Line 238, unix : %accept/reject
- Line 255, windows : if mod(j,25)==0; fprintf('  SMC stage %d/%d, accept=%.2f\n', j, J, AA(j)); end
- Line 328, windows : fprintf('\n--- CF Results: sell_limit=%d, sfrac=%d, positionschange=%d ---\n', round(sell_limit), sfrac, positionschange)

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/computation/histwc.m**

- Line 31, unix : vinterval = linspace(minV, maxV, nbins)-delta/2.0;

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/computation/cdf_estimator.m**

- Line 34, unix : % 1. probability of a yd that is negative/positive

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/computation/pairwise_jointd_estimator.m**

- Line 35, unix : % 1. probability of a yd that is negative/positive

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/postestimation/riskaversion.m**
...
**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/computation/histwcv.m**

- Line 31, unix : vinterval = linspace(minV, maxV, nbins)-delta/2.0;

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/computation/evalkspdf_denom.m**

- Line 23, windows : fprintf('Kernel choice not defined or spelt wrong\n')

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/datacleaning/bondpriceimport.m**

- Line 83, unix : %compare within/across bond cusips: try to get a reference for CTD vs

**/var/folders/5q/yhcyv3z55wvg6lhgc3h22kk00000gq/T/20240555-4/replication-package/CDS/code/postestimation/truthfulpimmcheck.m**
...
- Line 58, unix : %round quantities AND the big vector of p/q
- Line 240, windows : fprintf('%-50s %10s %10s %18s\n', '', 'Mean', 'Sd', '[P10, P90]')
- Line 249, windows : fprintf(fid, ' & Mean & Sd & $[P_{10}, P_{90}]$ \\\\\n\\hline\n');
- Line 262, unix : disp('Table 3 saved to output/tables/table3.tex')
- Line 266, windows : fprintf('  Total auctions in sample: %d\n', size(aucidfslist,1))
- Line 267, windows : fprintf('  Total bidder-auction observations: %d\n', size(aucidfs,1))
- Line 268, windows : fprintf('  Median eligible bonds per auction: %.0f\n', median(OS1_nbonds))
- Line 271, windows : fprintf('  Requests of zero: %d\n', sum(noi==0))
- Line 273, windows : fprintf('  Auctions with no second stage (NOI=0): %d\n', sum(NOI==0))
- Line 278, windows : fprintf('  Mean quantity conditional on bidding (shares): %.2f\n', mean(maxQi(maxQi~=0)))
- Line 313, windows : fprintf(fid, ' & IMM Submission & Residualized bid \\\\\n\\hline\n');
- Line 318, windows : fprintf(fid, '\\hline\n');
- Line 325, unix : disp('Table OS.4 saved to output/tables/tableOS4.tex')
- Line 358, windows : fprintf(fid, 'VARIABLES & (1) Auction Price & (2) Auction IMM \\\\\n\\hline\n');
- Line 371, windows : fprintf(fid, '\\hline\n');
- Line 378, unix : disp('Table OS.5 saved to output/tables/tableOS5.tex')
- Line 394, windows : fprintf('  N = %d\n', size(br_beta,2));
- Line 416, windows : fprintf('  Mean Opp. coef = %.2f (%.2f), N = %d\n', b(1), se(1), size(meanpricesub,2));
- Line 430, windows : fprintf(fid, '\\hline\n');
- Line 436, unix : disp('Table A.1 saved to output/tables/tableA1.tex')
