function [vout,nout]=complex_estimator_step2(nlowF,nupF,extrainfo,supplyp,supplyq,idfs,idss,ndraw,NOItotexp,noi,Npossibleexp,supplyp2, supplyq2,drawnids,trueaucidd,idsstrue,carriedoverp, carriedoverq,immcap2,NOIlong,eta,idfstrue,Bondvol,imm1cap,orig,maxSlope,prsel,imm)
maxSlope=0;
...
nupo=nup;
        ...
        nlow=nlowF(kk);nup=nupF(kk);nlowo=nlow; nupo=nup;vlow=vmind; vup=vmaxd; imp=imm1cap(kk);
