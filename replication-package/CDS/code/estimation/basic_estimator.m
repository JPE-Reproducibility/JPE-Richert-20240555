function [vout,nout]=basic_estimator(supplyp,supplyq,idfs,idss,ndraw,NOItotexp,noi,Npossibleexp,supplyp2, supplyq2,drawnids,trueaucidd,idsstrue,carriedoverp, carriedoverq,immcap2,NOIlong,eta,idfstrue,Bondvol,imm1cap,orig,maxSlope,prsel,imm)
maxSlope=0;
